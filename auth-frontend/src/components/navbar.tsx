import { Menu, X, User, Settings, LogIn, LogOut, HelpCircle, Search } from "lucide-react";
    ...
    <>
      <header className={`fixed top-0 left-0 right-0 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between z-50 transition-all duration-300 ${scrolled ? "bg-white backdrop-blur-md shadow-lg" : "bg-linear-to-r from-[#ECEFCA] via-[#ECEFCA] to-[#ECEFCA] shadow-md"}`}>
        ...
        <div className="hidden lg:flex flex-1 max-w-2xl mx-8">
          <div className="relative w-full group">
            <input type="text" placeholder="Search for jobs:" className="w-full px-6 py-3 pr-14 bg-white border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition-all duration-300 group-hover:border-gray-300 shadow-sm" />
      ...
      <div className="hidden md:block lg:hidden fixed top-18 left-0 right-0 px-4 sm:px-6 py-3 z-40 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
        <div className="relative max-w-3xl mx-auto group">
          <input type="text" placeholder="Search for Category..." className="w-full px-6 py-3 pr-14 bg-white border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition-all duration-300 shadow-sm" />
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-30 left-4 right-4 bg-white rounded-2xl shadow-2xl z-50 md:hidden overflow-hidden">
          <div className="p-6 flex flex-col gap-1">
            ...
            <a href="#" className="text-lg font-medium text-gray-800 hover:text-amber-600 hover:bg-amber-50 px-4 py-3 rounded-xl transition-all duration-200">Categories</a>
